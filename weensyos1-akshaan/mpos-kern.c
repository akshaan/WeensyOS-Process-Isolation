...
/***************************************************************************
*
* do_thread is the function that is called by the interrupt() in the INT_SYS_NEWTHREAD clause.
*
****************************************************************************/
...
static pid_t do_thread(void(*start_function)(void),process_t *parent)
{
	...
	uint32_t src_stack_bottom, src_stack_top;                                       uint32_t dest_stack_bottom, dest_stack_top;
